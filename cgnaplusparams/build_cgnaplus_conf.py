...
from .utils.se3_methods import build_chain as _build_chain
...
def cgnaplus_conf(
    ...
    poses = np.concatenate([
        ...
        [crick_phosphate_poses[i] for i in range(len(crick_phosphate_poses)) if crick_phosphate_contained[i]],
        ],
        axis=0)
